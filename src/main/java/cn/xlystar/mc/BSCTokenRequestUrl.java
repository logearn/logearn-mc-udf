...
/**
 * 计算引擎：maxCompute
 * bsc_token_request(String tokenAddress, String url)
 * url：要访问的url地址
 */
public class BSCTokenRequestUrl extends UDF {
    private final Logger log = LoggerFactory.getLogger(getClass());
    private int retryCount = 3;

    //    private String DEV_URL = "https://dev.kingdata.work:443/parse";
    private final String protocol = "https://";
    private String URL = "/logearn/warehouse/bsc_token_request";

    public BSCTokenRequestUrl() {
    }
    ...
    public static void main(String[] args) {
        BSCTokenRequestUrl requestUrl = new BSCTokenRequestUrl();
        for (int i = 0; i < 3; i++) {
