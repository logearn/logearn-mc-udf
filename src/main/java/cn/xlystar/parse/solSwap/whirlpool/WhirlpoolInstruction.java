...
public enum WhirlpoolInstruction {
    ...
    INITIALIZE_FEE_TIER("3"),                  // 初始化费率层级 [todo] 缺少 case
    ...
    SET_REWARD_AUTHORITY("22"),                // 设置奖励权限 [todo] 无具体case
    SET_REWARD_AUTHORITY_BY_SUPER_AUTHORITY("f09ac9c6945d3819"), // 通过超级权限设置奖励权限
    SET_REWARD_EMISSIONS_SUPER_AUTHORITY("24"), // 设置奖励发放超级权限 [todo] 无具体case
    ...
    COLLECT_PROTOCOL_FEES_V2("cf755fbfe5b4e20f"),           // 收取协议费 V2
    ...
    DELETE_TOKEN_BADGE("47");                 // 删除代币徽章 [todo] 缺少case
